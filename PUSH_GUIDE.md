...
Go to https://github.com/new, name it `ap-precalc-tutor` (private or public), and **do not**
initialize with a README. Copy the repo URL, e.g. `https://github.com/YOU/ap-precalc-tutor.git`.

## 2. Push from this machine

```bash
cd ~/workspace/ap-precalc-tutor
git remote add origin https://github.com/YOU/ap-precalc-tutor.git
git branch -M main
...
1. Go to https://vercel.com/new and **Import** the `ap-precalc-tutor` repo.
...
- Booking inquiries from `/contact` land in the admin **Inquiries** tab. Mark paid students enrolled under the **Students** tab.
